...
export default function DiagnosesScreen() {
  ...
  const { data: diagnosesData, isLoading } = useQuery({
    queryKey: ["patientDiagnosesLog", patientId, page],
        ...
        >
          <View style={s.intro}>
            ...
            <Text style={s.introSub}>
              Complete log of the patient's active and past clinical conditions.
            </Text>
          </View>
          ...
          {isLoading && page === 1 ? (
            ...
            <GlassCard style={s.emptyCard}>
              ...
              <Text style={s.emptyText}>No clinical records found.</Text>
            </GlassCard>
          ) : (
            <View style={s.list}>
