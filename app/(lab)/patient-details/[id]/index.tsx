        ...
        >
          ...
          <View style={s.section}>
            <GlassCard style={s.bentoCard}>
              ...
              <TouchableOpacity
                style={s.viewAllBtn}
                onPress={() => router.push(`/(lab)/patient-details/${patientId}/diagnoses` as any)}
              >
          ...
          <View style={[s.section, s.rowSection]}>
            <GlassCard style={[s.bentoCard, { flex: 1 }]}>
              ...
              <TouchableOpacity
                style={s.viewAllBtn}
                onPress={() => router.push(`/(lab)/patient-details/${patientId}/lab-analysis` as any)}
              >
            ...
            <GlassCard style={[s.bentoCard, { flex: 1 }]}>
              ...
              <TouchableOpacity
                style={s.viewAllBtn}
                onPress={() => router.push(`/(lab)/patient-details/${patientId}/vaccines` as any)}
              >
                <Text style={s.viewAllText}>Full Log</Text>
              </TouchableOpacity>
                ...
                {visibleEvents.length > 0 ? (
                  <>
                    ...
                    {hasMore && (
                      <TouchableOpacity
                        style={s.loadMoreBtn}
                        onPress={() => router.push(`/(lab)/patient-details/${patientId}/activity` as any)}
                      >
