  ...
  const handleBarCodeScanned = async ({ data }: { data: string }) => {
    ...
    if (reservation.status === "done") {
      Toast.show({
        ...
        text2: "This analysis is already finished.",
      });
      return;
    }
  ...
  const handleManualAction = async () => {
    ...
    try {
      ...
      Toast.show({
        type: "success",
        text1: "Success",
        text2: `Analysis ${isStarting ? "started" : "concluded"} manually.`,
      });
    ...
    <View style={styles.container}>
      ...
      <View style={styles.overlay}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Lab QR Scanner</Text>
        </View>
          ...
          <GlassCard style={styles.infoCard} variant="subtle">
            ...
            <View style={styles.actionRow}>
              ...
              <Text style={styles.hintText}>
                Aim camera at the patient's check-in QR code for analysis
              </Text>
            </View>
          </GlassCard>
        </View>
      ...
      {processing && (
        <View style={styles.processingOverlay}>
          <ActivityIndicator color={COLORS.primary} size="large" />
          <Text style={styles.processingText}>UPDATING ANALYSIS...</Text>
        </View>
      )}
    </View>
  );
